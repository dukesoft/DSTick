///Movement
/*
x += (keyboard_check(vk_right) - keyboard_check(vk_left))*obj_example_dstick_main.player_speed*__obj_dsnet_container.delta;
y += (keyboard_check(vk_down) - keyboard_check(vk_up))*obj_example_dstick_main.player_speed*__obj_dsnet_container.delta;
