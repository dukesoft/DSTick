if (obj_example_dstick_main.entity_interpolation && ds_list_size(positions) >= 2) {
	...
	var render_timestamp = current_time// - obj_example_dstick_client.tick_timer*1000 //1000/obj_example_dstick_client.server_tickrate;
	...
	var interp_position = 1+(((render_timestamp - t0) / (t1-t0)));
